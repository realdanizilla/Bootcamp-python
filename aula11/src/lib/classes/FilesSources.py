...
# essa é uma classe filha da Abstract, então ela precisa implementar todos os métodos com decorador @bsatractmethod, 
# ainda que seja só com "pass" como o get_data
